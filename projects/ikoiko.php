	...
	<div class="project-details">
		<ul>
			<li>
				...
				<div class="project-detail-info">Graphic Designer</div>
			</li>
			<li>
				<div class="project-detail-label">YEAR</div>
				<div class="project-detail-info">2014 - Present</div>
			</li>
			<li>
				<div class="project-detail-label">WEBSITE</div>
				<div class="project-detail-info"><a href="http://www.ikoiko.co.nz" target="_blank">ikoiko.co.nz</a></div>
			</li>
		</ul>
	</div>
